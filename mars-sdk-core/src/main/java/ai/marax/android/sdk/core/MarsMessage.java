...
public class MarsMessage {
    ...
    MarsMessage() {
        context = MarsElementCache.getCachedContext();
        this.anonymousId = context.getDeviceId();
        this.userId = context.getMaraxId();
    ...
    void setProperty(MarsProperty property) {
        if (property != null) this.properties = property.getMap();
    }

    void setUserProperty(MarsUserProperty userProperty) {
    ...
    void setMaraxId(String maraxId) {
